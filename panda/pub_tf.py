...
class SensorTransformsPublisher(Node):
    def __init__(self):
        ...
        # transient_local qos
        qos = rclpy.qos.QoSProfile(depth=10, durability=rclpy.qos.QoSDurabilityPolicy.TRANSIENT_LOCAL)
        self.transform_pub = self.create_publisher(TFMessage, '/tf_static', qos)
    ...
    def publish_transforms(self):
        ...
        # Publish transform for sensor 2
        ...
        sensor2_transform.transform.translation.z = 0.058
